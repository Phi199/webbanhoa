...
$product_node = $_POST['product_node'];
   ...
   if(isset($_POST['add_product'])){
      $insert = "INSERT INTO products(name,price,image,node) VALUE ('".$product_name."', '".$product_price."', '".$product_image."','".$product_node."')";
      ...
      <table class="product-display-table">
         ...
         <tr>
            ...
            <td>
               ...
               <a href="../TinhNangQLDMSP/admin_page.php?idsanpham=<?php echo $row['id_pd']; ?>" class="btn">delete</a>
            </td>
         </tr>
      <?php } ?>
      </table>
